...
def translation_status():
    ...
    for s in models.Story.objects(pt_title__exists=True, fr_title__exists=True):
        fr_request = {'target_language': constants.FRENCH,\
                          'text': s.title, 'result': s.fr_title}
        pt_request = {'target_language': constants.PORTUGUESE,\
                          'text': s.title, 'result': s.pt_title}
